...
function SellerDash() {
  const [tasks, setTasks] = useState([
    { id: 1, title: "Design UI", status: "To Do", priority: "High", dueDate: "2025-04-15" },
    { id: 2, title: "Setup Backend", status: "In Progress", priority: "Medium", dueDate: "2025-04-20" },
    { id: 3, title: "API Integration", status: "Done", priority: "Low", dueDate: "2025-04-10" },
  ]);
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-lg shadow-sm">
              <h3 className="text-sm font-medium text-indigo-600 mb-1">Total Tasks</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg shadow-sm">
              <h3 className="text-sm font-medium text-blue-600 mb-1">Time Tracked</h3>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-4 rounded-lg shadow-sm">
              <h3 className="text-sm font-medium text-pink-600 mb-1">Current Bill</h3>
          ...
          <div className="mb-8">
            <div className="flex justify-between mb-1">
              ...
              <span className="text-indigo-600 font-medium">{completionPercentage.toFixed(0)}%</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {statuses.map((status) => (
              <div key={status} className="bg-gray-50 rounded-lg shadow-sm p-4 border border-gray-200">
                <h2 className="text-lg font-bold mb-4 flex items-center">
                  <span className={`w-3 h-3 rounded-full mr-2 ${
                    status === "To Do" ? "bg-indigo-400" : 
                    status === "In Progress" ? "bg-yellow-400" : "bg-green-400"
                  }`}></span>
                  {status}
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Timeline Overview</h2>
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  ...
                  {Array.from({ length: 7 }).map((_, i) => {
                    ...
                    return (
                      <div key={i} className="flex-1 text-center text-xs text-gray-500">
                        ...
                        <div className="text-gray-400 text-xs">{date.getDate()}</div>
                      </div>
                    );
                  })}
                </div>
              ...
              {tasks.map((task) => (
                <div key={task.id} className="flex items-center py-2 border-t border-gray-200">
                        ...
                        <div key={i} className="flex-1 px-1">
                          {isActive && (
                            <div className={`h-6 rounded-lg ${
                              ...
                              task.status === "In Progress" ? "bg-yellow-400" : "bg-indigo-400"
                            }`}></div>
                          )}
                        </div>
                      );
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Time & Billing</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <h3 className="text-sm font-medium text-gray-500 mb-1">Time Tracked This Week</h3>
                <div className="flex items-end">
                  <span className="text-3xl font-bold text-indigo-600">{timeTracked}</span>
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <h3 className="text-sm font-medium text-gray-500 mb-1">Billing Summary</h3>
                <div className="flex items-end">
                  <span className="text-3xl font-bold text-purple-600">${totalBill.toFixed(2)}</span>
