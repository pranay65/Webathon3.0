...
function LandingPage() {
  ...
  return (
    <div className="font-['Inter'] text-gray-800 overflow-x-hidden">
      ...
      {/* Hero Section - Enhanced with animated background + better visuals */}
      <section className="relative min-h-screen overflow-hidden">
        ...
        >
          <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 120L48 110C96 100 192 80 288 75C384 70 480 80 576 85C672 90 768 90 864 90C960 90 1056 90 1152 85C1248 80 1344 70 1392 65L1440 60V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0Z" fill="white"/>
          </svg>
        </motion.div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          ...
          >
            <span className="text-[#5C6BC0] font-semibold text-lg mb-2 block">Our Mission</span>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <span className="text-[#5C6BC0] font-semibold text-lg mb-2 block">What We Offer</span>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-[#5C6BC0] font-semibold text-lg mb-2 block">Simple Process</span>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-[#5C6BC0] font-semibold text-lg mb-2 block">Success Stories</span>
                  ...
                  >
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-[#5C6BC0]">{testimonials[activeTestimonial].role}</p>
                      </div>
                    </div>
                    <p className="text-gray-600 italic text-xl leading-relaxed">"{testimonials[activeTestimonial].text}"</p>
                  </motion.div>
                </AnimatePresence>
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-[#5C6BC0] font-semibold text-lg mb-2 block">Have Questions?</span>
      ...
      <section className="py-20 bg-gradient-to-r from-[#3949AB] to-[#42A5F5] text-white">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Freelance Journey?</h2>
            <p className="text-xl max-w-2xl mx-auto mb-10 text-blue-100">
              Join thousands of freelancers and clients creating success stories every day
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Connecting talent with opportunity in the digital age. Our platform revolutionizes how freelancers and clients work together.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-lg mb-6">Contact</h4>
              <p className="text-gray-400 mb-3">Email: support@freelancehub.com</p>
