...
const FreelancerProfile = () => {
  const initialData = {
    ...
    about:
      "Passionate freelancer with over 6 years of experience in web development and design. I specialize in creating responsive, user-friendly interfaces with modern technologies.",
    skills: [],
    certifications: [],
    portfolio: [
      {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 p-4 md:p-8 z-50 pt-32">
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden mt-12">
                          ...
                          <p className="flex items-center text-gray-700">
                            <span
                              className={`inline-block w-3 h-3 rounded-full mr-2 ${
                                userData.availability === "Available for Work"
                                  ? "bg-green-500"
                                  : "bg-yellow-500"
                              }`}
                            ></span>
