...
=======
    <>
      <Navbar />
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6 z-50 pt-16">
        <div className="w-full max-w-xl bg-white rounded-lg shadow-md p-8 mt-8">
